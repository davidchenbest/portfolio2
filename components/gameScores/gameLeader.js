...
export default function GameLeader({ game, type }) {
    ...
    return <>
        <Image src={`https://cdn.nba.com/headshots/nba/latest/260x190/${game.gameLeaders[typeName].personId}.png`} alt={game.gameLeaders[typeName].name} width='40' height='29' layout='fixed' unoptimized={IMG_UNOPTIMIZE} />
